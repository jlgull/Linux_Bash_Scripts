...
# 	This version uses if, elif and case for the evaluation.
#
# It will then process that information and tell the user what class 
#  the IPv4 address is and whether it is a loopback, public 
#  or private address. 
#
...
#
# Whether it is public or private will involve examining the first octet 
#  and, in some cases, the second.
#
...
#
# The following lines were for testing the cut process runs.
#
...
# 
# If valid numbers, less than 255, was entered in all 4 (four) Octets,
...
#
# Using the case command to resolve the Type issues.
#
	...
	case $Class in
		...
		B) if [[ Oct0 -eq 172 && ( Oct1 -ge 16 && Oct1 -le 31 ) ]]
			then
				Type=Private
		fi
		;;

		C) if [[ Oct0 -eq 192 && Oct1 -eq 168 ]]
			then
				Type=Private
		fi
		;;
