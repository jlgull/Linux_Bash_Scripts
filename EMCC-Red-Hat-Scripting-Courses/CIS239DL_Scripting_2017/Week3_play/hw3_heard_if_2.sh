...
#	This version uses only if and elif for the evaluation.
#
...
elif [[ ! $ipaddress =~ ^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}$ ]]
then
	echo; echo -e "The IPV4 address was invalid, this is what was entered: ${Red}$IPAddress${None}"
	echo; echo
